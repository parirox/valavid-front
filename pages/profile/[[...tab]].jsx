    ...
    return (
        <>
            ...
            <div className="w-full h-72 relative">
                <Image src='/images/profile-bg.png' fill alt="profile background" className="object-cover" />
            </div>
                ...
                <aside className="basis-1/4 rounded-2xl relative -top-52 bg-secondary-light p-10">
                    <div className="grid grid-cols-1 grid-rows-2 gap-10 relative">
                        <span className="absolute left-0 top-0">
                            <ButtonIcon icon={<MdEdit />} className="btn-accent text-2xl h-14 w-14" />
                        </span>
                        <div className="flex items-center flex-col gap-8 text-lg">
                            <div className="relative">
                                <div className="flex-initial">
                                    <span className="relative">
                                        <Image src={data.user.profile_image} alt={data.user.name} width={140} height={140} className="rounded-full" />
