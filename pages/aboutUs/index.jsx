...
export const InfoItemData = [{
    title: "تصویر", value: 1354, icon: <PicturIcon className="scale-[0.7]"/>,
}, {
    title: "ویدئو", value: 1354, icon: <VideoIcon className="scale-[0.7]"/>,
}, {
    title: "صوت", value: null, icon: <MusicIcon className="scale-[0.7]"/>,
}, {
    title: "تمپلیت", value: null, icon: <ThemeIcon className="scale-[0.7]"/>,
},];
const contactBoxes = [{
    connectionWay: "شماره تلفن", value: "09018899554", icon: <BsTelephoneFill className="text-white text-3xl"/>,
}, {
    connectionWay: "آیدی تلگرام", value: (<a href={"https://t.me/valadmin"} target={"_blank"} rel={"noreferrer"}>
        @valadmin
    </a>), icon: <FaTelegramPlane className="text-white text-3xl"/>,
}, {
    connectionWay: "ایمیل", value: "valavid_official@yahoo.com", icon: <AiFillMail className="text-white text-3xl"/>,
}, {
    connectionWay: "آدرس",
        ...
        <div className="relative mt-14">
            <div className="flex container">
                <div className="">
                    ...
                    <article className={"max-w-[62rem] prose-p:sm:text-lg text-justify prose-p:!leading-[3.5rem]"}>
                        <p>
                            ...
                            فیلمسازان بیشتری بتونن داستان های بهتری روایت کنن.
                        </p>
                        <p>
                            داستان والاوید
                            ...
                            تموم نشده باشه بتونید تصویربرداری کنید. قشنگ نیست؟!
                        </p>
                        <p>
                            اما از حق
                            ...
                            یک فیلم باید همه این مراحل رو طی کنیم و این همه هزینه بدیم؟
                        </p>
                        <p>
                            جواب
                        ...
                        <p>
                            حالا تصور کن که هر چیزی رو سرچ کنی اینجا بتونی تصویر مرتبط
                ...
                <div className="absolute z-[-1] top-0 left-5 hidden lg:block">
                    <Image alt={"درباره ی ما"} src={Pictures} className="object-cover w-auto h-auto" width={850}
                           height={250}></Image>
                    <div
                    className="bg-gradient-to-r from-secondary-500 via-[#00101c5a] to-secondary-500 w-full h-full absolute top-0 left-0 z-1 opacity-75"></div>
                    <div
                    className="bg-gradient-to-b from-secondary-500 via-[#00101c5a] to-secondary-500 w-full h-full absolute top-0 left-0 z-1 opacity-75"></div>
                </div>
            </div>
            <div className="container mt-24">
                <div className="flex flex-col lg:flex-row gap-20 items-end mb-16">
                    <div className="flex flex-col sm:flex-row gap-10 w-full lg:w-auto items-center">
                        ...
                        <p
                        className="text-xl opacity-40 font-thin mb-6 lg:hidden flex-1 flex items-center justify-center">با
                            ما در تماس باشید</p>
                    ...
                    <div className="w-full lg:flex-1">
                        ...
                        <div className="grid grid-cols-2 xl:grid-cols-3 gap-6">
                            {contactBoxes.map((box, i) => (<ContactUsBox
                            value={box.value}
                            connectionWay={box.connectionWay}
                            icon={box.icon}
                            className={i === 3 ? "col-span-2 xl:col-span-3" : i === 0 ? "sm:col-span-2 xl:col-span-1" : i === 2 ? "sm:col-span-1 col-span-2" : ""}
                            key={i}
                            ></ContactUsBox>))}
                        </div>
                    </div>
