        ...
        <div className="flex container">
          <div className="">
            ...
            <p className="max-w-[62rem] text-lg leading-[3.5rem]">
              ...
              اما از حق نگذریم مساله هزینه بالای تولید یک مساله جهانیه. هماهنگی عوامل تولید، آفیش تجهیزات، حمل و نقل و حتی تغذیه گروه از جمله چالش های تولیده که خیلی هم طبیعیه. اما یک سوال! آیا ما برای تک تک پلان های یک فیلم باید همه این مراحل رو طی کنیم و این همه هزینه بدیم؟
              جواب ما به این سوال یک نه بزرگه! قطعا لازم نیست هر بار چرخ از ابتدا خلق بشه. وقتی هنرمندان دیگری با تنوع بالا در قاب بندی و استفاده از تجهیزات مختلف از سوژه مورد نظر شما، آرشیوی از فوتیج آماده کرده اند که با چند کلیک ساده میتونی بهشون دسترسی پیدا کنی، دیگ صرف هزینه و و وقت برای مجوز و آفیش و رفت و آمد و.... چه معنی میتونه داشته باشه!
              حالا تصور کن که هر چیزی رو سرچ کنی اینجا بتونی تصویر مرتبط باهاش رو پیدا کنی و از بین هزاران فوتیج اونی که به داستانت نزدیک تره رو انتخاب کنی. دیگه نه نیازی به مجوز هست و نه هزینه های تولیدی روی دوشت سنگینی میکنه. اینجا برای تو آماده شده. پس فقط به داستانت فکر کن!
            </p>
          </div>
