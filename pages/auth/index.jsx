...
const Index = ({hasBackUrl}) => {
    ...
    const handleSignupUser = () => {
        let apiData = {
            ...
            number_email: isPersionMobileNumber(signupData.number_email) ? createValidMobileNumber(signupData.number_email) : signupData.number_email,
    ...
    return (<div className="min-h-screen flex items-center justify-center">
        ...
        <div className="flex relative w-full sm:w-auto">
            <div
            className="w-full sm:min-w-[300px] sm:max-h-[525px] mb-16 sm:mb-0 mt-24 sm:mt-0 bg-[#F2F2F3] w-100 mx-4 sm:mx-0 sm:w-[40.188rem] rounded-[23px] lg:rounded-tl-[0] lg:rounded-bl-[0] p-3">
                {(selectedTab === "login" || selectedTab === "signup") && (<>
                    <div>
                        <div
                        className="m-4 border-b border-secondary-300 text-[#90999F] flex text-2xl items-center justify-around">
                            <div
                            className={clsx("py-5 px-6 cursor-pointer", selectedTab === "signup" && "text-[#303D47] border-b-2 border-[#303D47]")}
                            ...
                            className={clsx("py-5 px-6 cursor-pointer", selectedTab === "login" && "text-[#303D47] border-b-2 border-[#303D47]")}
                            >
                                ورود
                            </div>
                        </div>
                    ...
                    <div>
                        {selectedTab === "login" && (<Login hasBackUrl={hasBackUrl} setSelectedTab={setSelectedTab}/>)}
                ...
                {selectedTab === "auth" && (<Authentication
            ...
            <div
            className="hidden lg:flex bg-hero-pattern bg-no-repeat bg-cover bg-center lg:w-[370px] xl:w-[600px] max-h-[525px] rounded-tl-[23px] rounded-bl-[23px] flex items-center justify-center">
...
export const getServerSideProps = async (context) => {
    const hasBackUrl = !!context.req.headers.referer
    return {
        props: {
            hasBackUrl
        },
