    ...
    >
      ...
      <div className="p-4">
        ...
        <p className="text-secondary-300 text-start my-[3rem]">
          در صورتی که پس از انجام تراکنش و کسر مبلغ آن از حساب شما{" "}
          {'"قدرت خرید"'} شما شارژ نشد مبلغ تراکنش در اسرع وقت به صورت خودکار
          (توسط سیستم بانکی) به حساب شما بزاگزدانده خواهد شد.
        </p>
        <Button
