        ...
        <div className="text-secondary text-start my-[3rem]">
          ...
          <span className="text-secondary block my-[2rem]">
            ...
            <p className="text-secondary">
              برای تغییر شماره حساب با کلیک بر روی لینک {'"تغییر شماره حساب"'}{" "}
              به حساب کاربری وارد میشوید پس از ورود در بخش اطلاعات حساب کاربری
              با کلیک بر روی شماره حساب خود میتوانید شماره حساب جدید خود را
              معرفی نمایید.
            </p>
          </span>
        </div>
