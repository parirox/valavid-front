...
import {useEditCollectionMutation, useRemoveCollectionMutation} from "@/datasources/user/remote/UserSliceApi";
import toast from "@/utils/notification/toast";

export default function EditCollection({show, showHandler, ...rest}) {
    // const {data,isSuccess,isError,isLoading} = useAddCollectionMutation()
    const [fetchEdit, {
        data: editData,
    ...
    const onSubmit = (data) => fetchEdit([{id}, data])
