        ...
        <div>
            <div className="flex gap-7 justify-between items-center pt-6">
                <div className="flex gap-5">
                    <Button className={'btn-primary py-4 px-7 rounded-full'}>تقاضای وجه</Button>
                    <Button className={'btn-ghost py-4 px-7 rounded-full'}>مشاهده ی جزئیات حساب</Button>
                </div>
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr className="h-16">
                            ...
                            <th className="text-start">تاریخ پرداخت </th>
                            ...
                            AccountingCardData.map((data, index) => (
                                <tr className="relative" key={index}>
                                    ...
                                    <td className="py-10 flex justify-center">{
                                        data.status == 1 ?
                                            <div className={'text-lg w-44 px-5 py-3 flex items-center gap-3 bg-accent rounded-3xl'} link={''}>
                                                <FiClock className="text-2xl text-[#ffffff96]"></FiClock>
                                                در حال برسی
                                            </div>
                                            :
                                            <div className={'text-xl w-44 px-5 py-3 flex items-center gap-3  bg-success rounded-3xl'} link={''}>
