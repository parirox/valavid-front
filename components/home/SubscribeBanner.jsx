...
const SubscribeBanner = () => {
    return (
        <div className="px-6 md:px-0 pb-44">
            <div className='px-6 py-4 container flex items-center flex-col md:flex-row bg-gradient-to-br from-[#AEAAFF] to-primary rounded-[2rem] lg:h-[32rem] w-full'>
                ...
                <div className="basis-1/2 w-full h-full items-center flex flex-row-reverse justify-center">
