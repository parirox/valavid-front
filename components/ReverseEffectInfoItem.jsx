const ReverseEffectInfoItem = ({ className, title, value, icon, disable }) => {
    return (
        <>
            <div className={`bg-neutral flex gap-5 rounded-full py-4 px-6 h-[8.25rem] items-center group ${disable ? '' : 'hover:bg-gradient-to-br hover:from-[#534CDA] hover:to-[#AEAAFF] hover:text-accent'} ${className}`}>
