...
const ReverseEffectInfoItem = ({ link,className, title, value, icon, disable }) => {
    return (
        <>
            <div className={`bg-neutral flex gap-2 xl:gap-5 rounded-full py-0 xl:py-4 px-3 xl:px-6 h-[6.25rem] xl:h-[8.25rem] items-center group ${disable ? '' : 'hover:bg-gradient-to-br hover:from-[#534CDA] hover:to-[#AEAAFF] hover:text-accent relative'} ${className}`}>
