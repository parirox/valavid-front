                ...
                <div className="w-full h-full p-3">
                    <Link href={link}>
                        <div className="relative w-full h-full rounded-[2.6rem] overflow-hidden">
                            <div
                                className="absolute inset-0 z-40 transition-400-linear opacity-0 group-hover/popularCard:opacity-100 py-12 px-10 flex flex-col justify-between">
                                    ...
                                    <div className="flex p-1 gap-3 justify-between">
                                        ...
                                        <div className="basis-auto">
                                            <div className="flex gap-3 justify-center items-center">
                                                <Badge
                                                    className='bg-primary rounded-2xl  text-2xl'><IoFolderSharp/></Badge>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-rows-2 grid-cols-2 h-full gap-2 group/collection">
                                {data.media.map((img, key) => (
                                    <div className="relative h-full" key={key}>
                                        <div
                                            className="absolute inset-0 z-10 bg-gradient-to-bl group-hover/popularCard:from-[#00101C99] group-hover/popularCard:to-[#0E1F2C14]"></div>
                                        <Image
                                            src={img.src}
